        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4 lg:gap-8">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-6 py-2 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full text-white font-medium hover:shadow-lg hover:shadow-cyan-500/25 transition-shadow"
            >
              Hire Me
            </motion.a>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}
              className="p-2 bg-[#25D366] rounded-full text-white hover:shadow-lg hover:shadow-[#25D366]/30 transition-shadow"
